...
/*
  ...
  $Source: /cvsroot/phpopenchat/chat3/Attic/unlock_channel.php,v $
  $Revision: 1.1.2.2 $
*/
...
if( !isset($_SESSION['chatter']) ) die('Permission denied');

if( isset($_POST['password']) 
 && $_SESSION['channel']->get_password() == $_POST['password'] )
{
  $_SESSION['chatter']->unlock_channel($_SESSION['channel']->get_name());
}
?>